...
//  int Trc1, Trc2 = 0;                                                             //переменная состояния линий Трансивер1 и Трансивер2. 0 - не подкл. 1 - к А1. 2 - к А2. 3 - к А3
  ...
  byte paLine = 2;                                                                   //переменная подключения усилителя: 1 - к Тр1. 2 - к Тр2
  ...
  boolean onCommut = true;                             //флаг необходимости перекоммутации. Если true - выполняется блок коммутации
