...
//************************* Назначаем переменные ***********************************
  ...
  volatile byte trx_upr_mode;                            //переменная режима управления передачей трансиверов: 0-без упр., 1-только блок., 2-упр.по текущему выбору, 3-полное управление
...
if (trx_upr_mode < 1 || trx_upr_mode > 3) {
  lcd.clear();
...
//***************************БЛОК коммутации (по флагу необходимости коммутации) *********************************
if (onCommut) {
