//Ѕиблиотека разрабатывалась дл€ контроллера CarDuino http://carmonitor.ru/ru/carduinonanoduo-p-120.html
//¬се права на библиотеку CyberLib принадлежат компании CarMonitor.ru
//ќбновлени€ библиотеки скачивайте на сайте http://www.cyber-place.ru/showthread.php?p=3789#post3789
...
//**************Beep**********************
void D0_Beep(uint16_t dur, uint16_t frq);
void D1_Beep(uint16_t dur, uint16_t frq);
void D2_Beep(uint16_t dur, uint16_t frq);
void D3_Beep(uint16_t dur, uint16_t frq);
void D4_Beep(uint16_t dur, uint16_t frq);
void D5_Beep(uint16_t dur, uint16_t frq);
void D6_Beep(uint16_t dur, uint16_t frq);
void D7_Beep(uint16_t dur, uint16_t frq);
void D8_Beep(uint16_t dur, uint16_t frq);
void D9_Beep(uint16_t dur, uint16_t frq);
void D10_Beep(uint16_t dur, uint16_t frq);
void D11_Beep(uint16_t dur, uint16_t frq);
void D12_Beep(uint16_t dur, uint16_t frq);
void D13_Beep(uint16_t dur, uint16_t frq);
...
#else
#error  ¬аш контроллер библиотекой CyBerLib не поддерживаетс€
#endif
